var advertorialVideo = {
    ...
    mainJS: function () {
        ...
        var sa_30s_video = '<div class="video-wrapper">' +
            '   <video width="100%" height="auto" autoplay controls class="wf-track-clicks-to-video-89">' +
            '    <source src="https://sandbox.echologyx.com/wp-content/uploads/2021/06/SA_30Sec_Landing.mp4" type="video/mp4">' +
            '  </video>' +
            '</div>'
